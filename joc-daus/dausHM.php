    ...
    <div class="col-md-6">
      ...
      <div class="card" style="width: 18rem;">
        <div class="card-body">
          ...
          <hr>
          <!-- Botó -->
          <p class="card-text">Tirar els daus!</p>
          <button type="button" onclick="iniciJoc()" class="btn btn-primary btn-lg btn-block">Tirar</button>
        </div>
      </div>
...
<script src="../assets/js/dausHM.js" charset="utf-8"></script>
